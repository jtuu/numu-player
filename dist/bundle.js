...
/***/ function(module, exports, __webpack_require__) {
	...
	const root_1 = __webpack_require__(67);
	const store_1 = __webpack_require__(99);
	const socket_1 = __webpack_require__(96);
	const actions_1 = __webpack_require__(95);
	react_dom_1.render(React.createElement(root_1.default, {store: store_1.default, history: react_router_1.browserHistory}), document.getElementById("app-root"));
	function isObject(o) {
	...
	socket_1.default.on("connect", () => {
	    ...
	    if (state.account.isInRoom) {
	        store_1.default.dispatch(actions_1.joinRoom(state.room.lastRoom, state.account.name));
	    }
	});
	socket_1.default.on("disconnect", () => {
	    const state = store_1.default.getState();
	    if (state.account.isInRoom) {
	        store_1.default.dispatch(actions_1.resetRoomState());
	        store_1.default.dispatch(actions_1.gotDisconnected());
	    }
	});
	socket_1.default.on("*", (eventName, value) => {
	    if (isObject(value)) {
	        store_1.default.dispatch(Object.assign({ type: eventName }, value));
	    }
	    else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	const react_router_1 = __webpack_require__(3);
	const routes_1 = __webpack_require__(89);
	const Root = ({ store, history }) => (React.createElement(react_redux_1.Provider, {store: store}, React.createElement(react_router_1.Router, {history: history, routes: routes_1.default})));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapActionCreators = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const home_1 = __webpack_require__(92);
	const room_1 = __webpack_require__(94);
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = (React.createElement(react_router_1.Route, {path: "/", component: app_1.default}, React.createElement(react_router_1.IndexRoute, {component: home_1.default}), React.createElement(react_router_1.Route, {path: "/room/:roomName", component: room_1.default})));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(1);
	const top_bar_1 = __webpack_require__(266);
	const App = ({ children }) => (React.createElement("div", null, React.createElement(top_bar_1.default, null), React.createElement("div", null, children)));
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	const react_router_1 = __webpack_require__(3);
	const NavLink = (props) => (React.createElement(react_router_1.Link, __assign({}, props, {activeClassName: "active"})));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(1);
	const join_room_1 = __webpack_require__(93);
	const styles = __webpack_require__(274);
	const Home = () => (React.createElement("div", {className: styles.home}, React.createElement("h2", null, "Welcome!"), React.createElement("p", null, "Join a room"), React.createElement(join_room_1.default, null)));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	const decorate = react_redux_1.connect(mapStateToProps, mapDispatchToProps);
	class JoinRoom extends React.Component {
	    constructor(props) {
	        ...
	        this.handleSubmit = event => {
	            ...
	            react_router_1.browserHistory.push(`/room/${room}`);
	            this.inputVal = "";
	        };
	    }
	    set inputVal(val) {
	    ...
	    render() {
	        return (React.createElement("form", {onSubmit: this.handleSubmit}, React.createElement("input", {type: "text", ref: "input", defaultValue: this.props.value}), React.createElement("button", {type: "submit"}, "Join")));
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = decorate(JoinRoom);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const react_redux_1 = __webpack_require__(68);
	const actions_1 = __webpack_require__(95);
	const chat_1 = __webpack_require__(101);
	const styles = __webpack_require__(272);
	...
	class Room extends React.Component {
	    ...
	    componentWillMount() {
	        this.props.dispatch(actions_1.joinRoom(this.props.params.roomName));
	    }
	    componentWillUnmount() {
	        this.props.dispatch(actions_1.leaveRoom(this.props.params.roomName));
	    }
	    render() {
	        return (React.createElement("div", {className: styles.room}, React.createElement("h2", null, this.props.name || "\u00a0"), React.createElement(chat_1.default, null)));
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = decorate(Room);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const socket_1 = __webpack_require__(96);
	const { ACTION_TYPE } = __webpack_require__(98);
	const store_1 = __webpack_require__(99);
	exports.changeOwnNick = (oldNick, newNick) => {
	    socket_1.default.emit(ACTION_TYPE.OWN_NICK_CHANGE, newNick);
	    return {
	...
	exports.gotDisconnected = () => {
	    return {
	        type: ACTION_TYPE.DISCONNECTED
	    };
	};
	exports.joinRoom = (room, nick) => {
	    socket_1.default.emit(ACTION_TYPE.JOIN_ROOM, { room: room, nick: nick });
	    return {
	        type: ACTION_TYPE.JOIN_ROOM,
	        room: room
	    };
	};
	exports.resetRoomState = () => {
	    return {
	        type: ACTION_TYPE.RESET_ROOM_STATE
	    };
	};
	exports.leaveRoom = (room) => {
	    socket_1.default.emit(ACTION_TYPE.LEAVE_ROOM, room);
	    return {
	        type: ACTION_TYPE.LEAVE_ROOM,
	        room: room
	    };
	};
	exports.addChatMessage = (message) => {
	    return {
	...
	exports.sendChatMessage = (message) => {
	    socket_1.default.emit(ACTION_TYPE.ADD_CHAT_MESSAGE, message);
	    store_1.default.dispatch(exports.addChatMessage(message));
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const io = __webpack_require__(97);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"ACTION_TYPE": {
			...
			"RESET_ROOM_STATE": "RESET_ROOM_STATE",
			"ROOM_STATE": "ROOM_STATE",
			"ADD_CHAT_MESSAGE": "ADD_CHAT_MESSAGE",
			"SEND_CHAT_MESSAGE": "SEND_CHAT_MESSAGE",
			"OWN_NICK_CHANGE": "OWN_NICK_CHANGE",
			"NICK_CHANGE": "NICK_CHANGE",
			"ENTERED_ROOM": "ENTERED_ROOM",
			"LEFT_ROOM": "LEFT_ROOM",
			"DISCONNECTED": "DISCONNECTED"
		},
		"MAX_SERVER_CHAT_HISTORY": 20,
		"MAX_CLIENT_CHAT_HISTORY": 300
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const redux_1 = __webpack_require__(75);
	const reducers_1 = __webpack_require__(100);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const redux_1 = __webpack_require__(75);
	const { ACTION_TYPE, MAX_SERVER_CHAT_HISTORY, MAX_CIENT_CHAT_HISTORY } = __webpack_require__(98);
	...
	const chat = (state = initialStates.chat, action) => {
	    switch (action.type) {
	        case ACTION_TYPE.ROOM_STATE: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const react_redux_1 = __webpack_require__(68);
	const chat_box_1 = __webpack_require__(102);
	const mapStateToProps = ({ room }) => {
	...
	const Chat = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(chat_box_1.default);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(1);
	const chat_user_list_1 = __webpack_require__(103);
	const chat_log_1 = __webpack_require__(105);
	const send_chat_message_1 = __webpack_require__(252);
	const CSSModules = __webpack_require__(107);
	const styles = __webpack_require__(255);
	const ChatBox = ({ users, messages }) => (React.createElement("div", {className: styles.chatbox}, React.createElement("div", {className: styles.topcont}, React.createElement("div", {className: styles.chatlog}, React.createElement(chat_log_1.default, {messages: messages})), React.createElement("div", {className: styles.userlist}, React.createElement(chat_user_list_1.default, {users: users}))), React.createElement("div", {className: styles.sendmessage}, React.createElement(send_chat_message_1.default, null))));
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = CSSModules(ChatBox, styles);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	const chat_user_1 = __webpack_require__(104);
	...
	class ChatUserList extends React.Component {
	    ...
	    render() {
	        return (React.createElement("ul", {className: styles.userlist}, this.props.users.map(user => (React.createElement(chat_user_1.default, __assign({key: user.id}, user))))));
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = ChatUserList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(1);
	const ChatUser = ({ nick }) => (React.createElement("li", null, nick));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	const chat_message_1 = __webpack_require__(106);
	...
	class ChatLog extends React.Component {
	    ...
	    render() {
	        return (React.createElement("ul", {className: styles.chatlog, ref: "log"}, this.props.messages.map(msg => (React.createElement(chat_message_1.default, __assign({key: msg.id}, msg))))));
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	const ChatMessage = ({ nick, text, timestamp }) => {
	    const nickEl = nick ? (React.createElement("span", {className: styles.nick}, nick)) : null;
	    return (React.createElement("li", {className: styles.message}, React.createElement("span", {className: styles.timestamp}, prettyDate(timestamp)), nickEl, React.createElement("span", {className: styles.text}, text)));
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = CSSModules(ChatMessage, styles);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isFunction2 = __webpack_require__(108);
	
	var _isFunction3 = _interopRequireDefault(_isFunction2);
	
	var _extendReactClass = __webpack_require__(110);
	
	var _extendReactClass2 = _interopRequireDefault(_extendReactClass);
	
	var _wrapStatelessFunction = __webpack_require__(242);
	
	var _wrapStatelessFunction2 = _interopRequireDefault(_wrapStatelessFunction);
	
	var _makeConfiguration = __webpack_require__(243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _linkClass = __webpack_require__(131);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isArray2 = __webpack_require__(128);
	...
	var _objectUnfreeze = __webpack_require__(132);
	...
	var _parseStyleName = __webpack_require__(134);
	
	var _parseStyleName2 = _interopRequireDefault(_parseStyleName);
	
	var _generateAppendClassName = __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMapData = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asciiToArray = __webpack_require__(237),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simpleMap = __webpack_require__(241);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(251)(content, {"sourceMap":true});
	if(content.locals) module.exports = content.locals;
	// Hot Module Replacement
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[path]___[name]__[local]___[hash:base64:5]!./../../../node_modules/sass-loader/index.js!./styles.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[path]___[name]__[local]___[hash:base64:5]!./../../../node_modules/sass-loader/index.js!./styles.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-components-chat-message-___styles__message___Y0JMs:nth-child(odd) {\n  background: rgba(153, 153, 153, 0.1); }\n\n.client-components-chat-message-___styles__message___Y0JMs:nth-child(even) {\n  background: rgba(179, 179, 179, 0.1); }\n\n.client-components-chat-message-___styles__message___Y0JMs > * + * {\n  margin-left: 5px; }\n\n.client-components-chat-message-___styles__message___Y0JMs .client-components-chat-message-___styles__timestamp___6KGaI {\n  color: #333333; }\n  .client-components-chat-message-___styles__message___Y0JMs .client-components-chat-message-___styles__timestamp___6KGaI:before {\n    content: \"[\"; }\n  .client-components-chat-message-___styles__message___Y0JMs .client-components-chat-message-___styles__timestamp___6KGaI:after {\n    content: \"]\"; }\n\n.client-components-chat-message-___styles__message___Y0JMs .client-components-chat-message-___styles__nick___1agtM {\n  color: #664785; }\n  .client-components-chat-message-___styles__message___Y0JMs .client-components-chat-message-___styles__nick___1agtM:after {\n    content: \":\"; }\n\n.client-components-chat-message-___styles__message___Y0JMs .client-components-chat-message-___styles__text___V_Qzi {\n  word-wrap: break-word;\n  color: #4d4d4d; }\n\n.client-components-chat-message-___styles__message___Y0JMs .client-components-chat-message-___styles__nick___1agtM + .client-components-chat-message-___styles__text___V_Qzi {\n  color: black; }\n", ""]);
	
	// exports
	exports.locals = {
		"message": "client-components-chat-message-___styles__message___Y0JMs",
		"timestamp": "client-components-chat-message-___styles__timestamp___6KGaI",
		"nick": "client-components-chat-message-___styles__nick___1agtM",
		"text": "client-components-chat-message-___styles__text___V_Qzi"
	};
	...
	class SendChatMessage extends React.Component {
	    constructor(props) {
	        ...
	        this.handleSubmit = event => {
	            ...
	            this.props.dispatch(actions_1.sendChatMessage({
	    ...
	    render() {
	        return (React.createElement("form", {className: styles.form, onSubmit: this.handleSubmit}, React.createElement("input", {className: styles.input, type: "text", ref: "input"}), React.createElement("button", {type: "submit"}, "Send")));
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = decorate(SendChatMessage);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-components-chat-log-___styles__chatlog___1DtZI {\n  list-style: none;\n  padding-left: 0;\n  margin: 0;\n  height: 400px;\n  overflow-y: scroll; }\n", ""]);
	
	// exports
	exports.locals = {
		"chatlog": "client-components-chat-log-___styles__chatlog___1DtZI"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-components-chat-box-___styles__chatbox___2mud7 {\n  background: #e6d9f2;\n  max-width: 100%;\n  width: 600px; }\n  .client-components-chat-box-___styles__chatbox___2mud7 .client-components-chat-box-___styles__topcont___yciJC > * {\n    display: inline-block; }\n  .client-components-chat-box-___styles__chatbox___2mud7 .client-components-chat-box-___styles__topcont___yciJC .client-components-chat-box-___styles__chatlog___2ugIQ {\n    width: 80%; }\n  .client-components-chat-box-___styles__chatbox___2mud7 .client-components-chat-box-___styles__topcont___yciJC .client-components-chat-box-___styles__userlist___1G73- {\n    width: 20%;\n    background-color: rgba(26, 26, 26, 0.1); }\n", ""]);
	
	// exports
	exports.locals = {
		"chatbox": "client-components-chat-box-___styles__chatbox___2mud7",
		"topcont": "client-components-chat-box-___styles__topcont___yciJC",
		"chatlog": "client-components-chat-box-___styles__chatlog___2ugIQ",
		"userlist": "client-components-chat-box-___styles__userlist___1G73-"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-components-chat-user-list-___styles__userlist___2DxLg {\n  list-style: none;\n  padding-left: 0;\n  margin: 0;\n  height: 400px;\n  overflow-y: scroll; }\n", ""]);
	
	// exports
	exports.locals = {
		"userlist": "client-components-chat-user-list-___styles__userlist___2DxLg"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-containers-send-chat-message-___styles__form___leTI1 {\n  display: flex; }\n  .client-containers-send-chat-message-___styles__form___leTI1 .client-containers-send-chat-message-___styles__input___1pimg {\n    line-height: 2em;\n    flex: 1; }\n", ""]);
	
	// exports
	exports.locals = {
		"form": "client-containers-send-chat-message-___styles__form___leTI1",
		"input": "client-containers-send-chat-message-___styles__input___1pimg"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(1);
	const nav_link_1 = __webpack_require__(91);
	const user_quickmenu_1 = __webpack_require__(267);
	const styles = __webpack_require__(270);
	const TopBar = () => (React.createElement("div", {className: styles.topbar}, React.createElement("div", {className: styles.left}, React.createElement("h1", null, React.createElement(nav_link_1.default, {to: "/", onlyActiveOnIndex: true}, "Numu-player"))), React.createElement("div", {className: styles.right}, React.createElement(user_quickmenu_1.default, null))));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	const react_redux_1 = __webpack_require__(68);
	const styles = __webpack_require__(268);
	const actions_1 = __webpack_require__(95);
	const mapStateToProps = ({ account }) => {
	...
	const decorate = react_redux_1.connect(mapStateToProps, mapDispatchToProps);
	const UserQuickmenu = ({ name, dispatch }) => (React.createElement("a", {className: styles.cont, href: "javascript:void(0)", onClick: (event) => {
	    const newNick = window.prompt("New nickname:");
	    if (newNick) {
	        dispatch(actions_1.changeOwnNick(name, newNick));
	    }
	}}, React.createElement("div", {className: styles.avatar}), React.createElement("div", {className: styles.name}, name || "Not logged in")));
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = decorate(UserQuickmenu);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-containers-user-quickmenu-___styles__cont___35ZkH {\n  height: 100%;\n  width: 4.5em;\n  display: block; }\n  .client-containers-user-quickmenu-___styles__cont___35ZkH .client-containers-user-quickmenu-___styles__avatar___2SUvc {\n    background-image: url(http://i.imgur.com/PAcnjLm.png);\n    background-size: cover;\n    border-radius: 50%;\n    width: calc(100% - 0.7em);\n    height: calc(100% - 0.7em);\n    margin: auto; }\n  .client-containers-user-quickmenu-___styles__cont___35ZkH .client-containers-user-quickmenu-___styles__name___WVn5B {\n    width: 100%;\n    text-align: center;\n    background: white;\n    color: black;\n    font-size: 0.7em;\n    line-height: 1em;\n    margin: auto; }\n", ""]);
	
	// exports
	exports.locals = {
		"cont": "client-containers-user-quickmenu-___styles__cont___35ZkH",
		"avatar": "client-containers-user-quickmenu-___styles__avatar___2SUvc",
		"name": "client-containers-user-quickmenu-___styles__name___WVn5B"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-components-top-bar-___styles__topbar___3WBoc {\n  width: 100%;\n  height: 4.5em;\n  background-color: #b3bbe6;\n  display: flex;\n  justify-content: space-between; }\n", ""]);
	
	// exports
	exports.locals = {
		"topbar": "client-components-top-bar-___styles__topbar___3WBoc"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-containers-room-___styles__room___1jd5D {\n  margin: 1%; }\n", ""]);
	
	// exports
	exports.locals = {
		"room": "client-containers-room-___styles__room___1jd5D"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".client-components-home-___styles__home___3oq-z {\n  margin: 20px; }\n", ""]);
	
	// exports
	exports.locals = {
		"home": "client-components-home-___styles__home___3oq-z"
	};
